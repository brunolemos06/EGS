...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> fetchData() async {
    ...
    if (token != null) {
      ...
      if (response.statusCode == 200) {
        ...
        if (responsefetch.statusCode == 200) {
          ...
          final String url_owner = 'http://ridemate.deti:8080/owner/';
          ...
          final String url_get_participating =
              'http://ridemate.deti:8080/participant?trip_id=$user_id';
        ...
        final String urlTrips = 'http://ridemate.deti:8080/trip/';
    ...
    final response = await http.get(Uri.parse(
        'http://ridemate.deti:8080/service-review/v1/review/rating?personid=$_id'));
    final response2 = await http.get(Uri.parse(
        'http://ridemate.deti:8080/service-review/v1/review?personid=$_id'));
                                ...
                                onPressed: () async {
                                  ...
                                  final url_delete_conversation =
                                      await http.delete(Uri.parse(
                                          'http://ridemate.deti:8080/service-review/v1/conversations?f_name=$owner_id'));
                                  final String url =
                                      'http://ridemate.deti:8080/trip/';
                                        ...
                                        actions: [
                                          ...
                                          ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              final url3 =
                                                  'http://ridemate.deti:8080/service-review/v1/review?trip_id=$ownerid';
                                              ...
                                              if (response3.statusCode == 200) {
                                                ...
                                                // post review
                                                final url = 'http://ridemate.deti:8080/service-review/v1/review';
                            ...
                            ElevatedButton(
                              onPressed: () async {
                                final String url_delete_participant =
                                    'http://ridemate.deti:8080/participant/';
