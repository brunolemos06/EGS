...
#     m_id = db.Column(db.String(80), primary_key=True)
#     body = db.Column(db.String(80), unique=False, nullable=False)
#     conversation_id = db.Column(db.String(80), db.ForeignKey('conversation.c_id'), nullable=False)
#     author = db.Column(db.String(80), db.ForeignKey('participant.p_id'), nullable=False)

# class Conversation(db.Model):
#     c_id = db.Column(db.String(80), primary_key=True)
#     friendly_name = db.Column(db.String(80), unique=False, nullable=False)
...
#     con_id = db.Column(db.String(80), db.ForeignKey('conversation.c_id'), nullable=True)
#     identity = db.Column(db.String(80), unique=False, nullable=False)
...
#when app.py stops running, the db will be deleted

#make one method on init that will get all the conversations, participants, and messages
